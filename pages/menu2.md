...
Which you can use like this `{{m1fill title}}`: **{{m1fill title}}**. Of course  in this specific case you could also have used `{{fill title pages/menu1}}`: **{{fill title pages/menu1}}**.
...
For instance you can use it to customise how [tag pages look like](/pages/menu3/#customising_tag_pages).
